...
//       {/* Background */}
//       <div className="absolute inset-0 bg-gradient-to-b from-[#1a1814] to-[#0f0e0a] rounded-2xl -z-10" />
      
//       {/* Ambient glow */}
//       <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-amber-800/10 rounded-full blur-3xl -z-10" />

//       {/* Centered animation container - wider for handle space */}
//       <div className="relative w-full max-w-lg mx-auto h-full">
        
//         {/* Premium Kettle - gold accents, more detailed */}
...
//               {/* Premium kettle body - elegant shape */}
//               <path
...
//               />
//               {/* Gold rim */}
//               <ellipse cx="45" cy="18" rx="24" ry="6" fill="#3A3022" stroke="#D4A574" strokeWidth="1.5"/>
//               <ellipse cx="45" cy="18" rx="20" ry="4" fill="#2A2418" />
//               {/* Gold handle - elegant curve */}
//               <path
...
//               <path d="M22 50 L68 50" stroke="#D4A574" strokeWidth="1" opacity="0.6"/>
//               <path d="M22 55 L68 55" stroke="#D4A574" strokeWidth="0.5" opacity="0.4"/>
...
//         {/* Premium Tea Cup - with plenty of space for handle */}
...
//               <div className="absolute inset-0 rounded-full border border-D4A574/30" />
//             </div>
...
//               {/* Cup rim with gold accent */}
//               <ellipse cx="47.5" cy="32" rx="31" ry="7" fill="#3A3022" stroke="#D4A574" strokeWidth="1.5" />
//               <ellipse cx="47.5" cy="32" rx="27" ry="5" fill="#2A2418" />
              
//               {/* Tea liquid filling - premium amber */}
//               <motion.path
...
//               {/* Tea surface with subtle shimmer */}
//               {fillLevel > 0.6 && (
//                 <motion.ellipse
//                   cx="47.5"
//                   cy="36"
...
//               {/* Elegant cup handle - extended to the right with more space */}
//               <path
...
//               {/* Decorative gold band on cup */}
//               <path d="M24 52 L71 52" stroke="#D4A574" strokeWidth="0.8" opacity="0.5"/>
//               <path d="M25 56 L70 56" stroke="#D4A574" strokeWidth="0.5" opacity="0.3"/>
...
//             {/* Steam rising from cup - enhanced */}
